import { Container, Box, Package } from "lucide-react";
...
const FloatingContainers = () => {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
      ...
      />
      <Container 
        className="absolute top-1/3 right-1/4 w-16 h-16 text-accent/20 animate-float-slow"
        strokeWidth={1}
        style={{ animationDelay: "3s" }}
      />
      <Box 
        className="absolute bottom-20 right-10 w-20 h-20 text-primary/20 animate-float"
        strokeWidth={1}
